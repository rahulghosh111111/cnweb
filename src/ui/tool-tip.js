      ...
      {items.map((item, idx) => (
        <div
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 lg:h-14 lg:w-14 h-10 w-10 rounded-full border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105" />
        </div>
      ))}
    </>
  );
