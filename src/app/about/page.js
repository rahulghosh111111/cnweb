            ...
            <div className="md:w-1/2 flex flex-col items-center">
              <div className="flex items-center justify-center p-6">
                <Image
                  ...
                  width={500}
                  height={300}
                  className="absolute  mt-60 mr-10  max-w-sm  right-1/2 transform -translate-x-1/4 w-auto max-w-xs sm:max-w-sm md:max-w-md h-auto"
                />
              </div>
            </div>
            <div className="md:w-1/2 text-[#E58282] w-full">
              <h3 className="text-xl sm:text-2xl font-semibold mb-6 text-right">Frequently Asked <br /> Question</h3>
              <form className="space-y-4">
                ...
                <button type="submit" className="bg-orange-500 text-white font-semibold px-6 py-2 rounded-xl hover:bg-orange-600 transition block ml-auto">
                  Submit Questions
                </button>
              </form>
            </div>
