...
const JoinEvent = () => {
  return (
    <div className="relative bg-gradient-to-br from-black via-[#0d0d0d] to-black flex flex-col sm:flex-row items-center justify-between px-4 pb-8 sm:px-6 lg:px-12  mx-auto sm:py-10 py-6 overflow-hidden">
